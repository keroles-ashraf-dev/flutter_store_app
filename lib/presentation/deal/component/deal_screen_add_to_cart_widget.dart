...
class DealScreenAddToCartWidget extends StatelessWidget {
  const DealScreenAddToCartWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocConsumer<DealScreenBloc, DealScreenState>(
