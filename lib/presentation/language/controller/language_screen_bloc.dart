...
class LanguageScreenBloc extends Bloc<LanguageScreenEvent, LanguageScreenState> {
  ...
  LanguageScreenBloc(this._appPrefs) : super(LanguageScreenState(selectedLang:AppLocalization.currentLanguage)) {
  ...
  Future<void> _languageApplyEvent(LanguageScreenApplyLanguageEvent event, Emitter<LanguageScreenState> emit) async {
    ...
    if(success) emit(LanguageScreenState(selectedLang:event.selectedLang, apply: true));
  }
}
