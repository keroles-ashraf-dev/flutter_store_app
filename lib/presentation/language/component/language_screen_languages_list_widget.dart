...
class LanguageScreenLanguagesListWidget extends StatelessWidget {
  ...
  const LanguageScreenLanguagesListWidget({Key? key, required this.selectedLang})
      : super(key: key);
      ...
      itemBuilder: (context, i) {
        return Container(
          ...
          child: ListTile(
            ...
            title: Text(LanguageEnum.values[i].name.i18n(), textAlign: TextAlign.center),
  ...
  void _changeSelectedLang(BuildContext context, LanguageEnum lang) {
    BlocProvider.of<LanguageScreenBloc>(context).add(LanguageScreenChangeLanguageEvent(lang));
  }
}
