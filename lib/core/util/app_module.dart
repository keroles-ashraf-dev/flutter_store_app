...
class AppModule {
  ...
  static void init() {
    ...
    di.registerFactory<MainScreenBloc>(
        () => MainScreenBloc(di<GetAddressUsecase>()));
    ...
    di.registerLazySingleton<GetDealUsecase>(
    ...
    di.registerLazySingleton<BaseCategoryRepository>(() =>
        CategoryRepositoryImpl(
            di<ErrorHandler>(),
            di<NetworkInfo>(),
            di<BaseCategoryLocalDatasource>(),
            di<BaseCategoryRemoteDatasource>()));
    di.registerLazySingleton<BaseCarouselRepository>(() =>
        CarouselRepositoryImpl(
            di<ErrorHandler>(),
            di<NetworkInfo>(),
            di<BaseCarouselLocalDatasource>(),
            di<BaseCarouselRemoteDatasource>()));
    di.registerLazySingleton<BaseAddressRepository>(() => AddressRepositoryImpl(
        di<ErrorHandler>(),
        di<NetworkInfo>(),
        di<BaseAddressLocalDatasource>(),
        di<BaseAddressRemoteDatasource>()));
    ...
    di.registerLazySingleton<BaseAddressRemoteDatasource>(
        () => AddressRemoteDatasourceImpl(di<ApiManager>()));
    ...
    di.registerLazySingleton<BaseAddressLocalDatasource>(() =>
        AddressLocalDatasourceImpl(di<ErrorHandler>(), di<CacheManager>()));
  }
}
