...
class AppModule {
  ...
  void _initSplashModule() {
    ...
    if (!isRegistered<ErrorHandler>()) {
      _sl.registerLazySingleton<ErrorHandler>(() => ErrorHandler());
    }
    if (!isRegistered<ApiManager>()) {
